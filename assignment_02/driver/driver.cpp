...
// This will help us find the assignment directory,
...
fs::path findRoot()
{
    ...
    {
        if (fs::exists(
                current_path / assignmentConfig.dirname))
        {
            current_path =
                current_path / assignmentConfig.dirname;
    ...
    throw runtime_error(
        ...
        "make sure the configured assignment directory exists"
    );
}
